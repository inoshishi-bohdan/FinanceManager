...
export default function ExpenseForm({ title, record, onCancel, mutationFn, onSuccess }) {
   const { data: expenseCategories, isPending: isPendingCategories } = useMyQuery(fetchExpenseCategories, ['expense-categories']);
   ...
   return (
      <form onSubmit={handleSubmit}>
         ...
         {expenseCategories && <FormSelect
            ...
            defaultValue={record?.expenseCategoryId ?? ''}
